...
![Vista principal](/user-guide-images/mainview-salesperson.png)
...
![Venta](/user-guide-images/salesperson-sale.png)
...
![Venta](/user-guide-images/salesperson-saleitem.png)
...
![Clientes](/user-guide-images/salesperson-customers.png)
...
![Crear/editar cliente](/user-guide-images/salesperson-customeredit.png)
...
![Productos](/user-guide-images/salesperson-products.png)

### 2.4. Historial de Ventas
1. Ve a la sección **"Historial Ventas"**.

![Historial ventas](/user-guide-images/salesperson-sales.png)
...
![Detalle venta](/user-guide-images/salesperson-saledetail.png)
...
![Productos](/user-guide-images/inventory-products.png)
...
![Proveedores](/user-guide-images/inventory-suppliers.png)
...
![Dashboard](/user-guide-images/salesmanager-dashboard1.png)
...
![Reportes detallados](/user-guide-images/salesmanager-dashboard2.png)
...
![Gestión usuarios](/user-guide-images/admin-users.png)
...
![Configuración sistema](/user-guide-images/admin-system.png)
